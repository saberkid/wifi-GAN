...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=4, in_channels=64):
        ...
        self.linear = nn.Linear(512 * block.expansion * 6, num_classes)
...
def ResNetCSI(num_classes=4, in_channels=64):
...
def test():
    ...
    writer = SummaryWriter(log_dir='log', comment='resnetCSI')
    with writer:
